...
namespace AwesomeEmail
{
    public partial class Client : Form
    {
        ...
        #region method Recive Emails
        /// <summary>
        /// Recive Emails and show emails when clicked methods
        /// </summary>
        ...
        private void ReceiveMails()
        {
            ...
            try
            {
                ...
                pop3Client.Connect(Settings.Default.PopServer, int.Parse(Settings.Default.PopPort), useSslCheckBox.Checked);
        ...
        protected void SendMailgo()
        {
            ...
            string body = "From: " + From.Text + "\n";
            body += "Email: " + From.Text + "\n";
